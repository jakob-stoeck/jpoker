...
(function($) {
    ...
    jpoker.plugins.tourneyAdminEdit.defaults = $.extend({
            ...
            templates: {
                layout: '<form action=\'javascript://\'><div class=\'jpoker_admin_tourney_params\'>{sit_n_go}{start_time}{register_time}{resthost_serial_select}{name}{description_short}{description_long}{variant}{betting_structure}{players_min}{players_quota}{seats_per_game}{player_timeout}{currency_serial_select}{currency_serial_from_date_format}{buy_in}{rake}{prize_min}{bailor_serial}{breaks_first}{breaks_interval}{breaks_duration}{respawn}{active}{serial}</div>{update}</form>',
		...
		resthost_serial_option: '<option value=\'{serial}\'>{host}:{port}{path}</option>',
                ...
                start_time: '<div class=\'jpoker_admin_start_time\'><label for=\'jpoker_admin_start_time_input\'>Start time</label><input id=\'jpoker_admin_start_time_input\' type=\'text\' size=\'14\' value=\'{start_time_string}\' name=\'start_time\' title=\'Time and date of the tournament start.\' /><button type=\'button\'>pick</button></label></div>',
                register_time: '<div class=\'jpoker_admin_register_time\'><label for=\'jpoker_admin_register_time_input\'>Register time</label><input id=\'jpoker_admin_register_time_input\' type=\'text\' size=\'14\' value=\'{register_time_string}\' name=\'register_time\' title=\'Time and date of the registration.\' /><button type=\'button\'>pick</button></div>',
                description_short: '<div class=\'jpoker_admin_description_short\'><label for=\'jpoker_admin_description_short_input\'>Description short</label><input id=\'jpoker_admin_description_short_input\' name=\'description_short\' title=\'Short description of the tournament. It will be displayed on each line of the tournament list.\' value=\'{description_short}\' maxlength=\'20\' size=\'20\' /></div>',
		...
		name: '<div class=\'jpoker_admin_name\'><label for=\'jpoker_admin_name_input\'>Name</label><input id=\'jpoker_admin_name_input\' name=\'name\' title=\'Tourney name\' value=\'{name}\' maxlength=\'10\' size=\'10\' /></div>',
		...
		active: '<div class=\'jpoker_admin_active\'><input id=\'jpoker_admin_active_input\' name=\'active\' type=\'checkbox\' title=\'Control if the tournament is considered by the server.\'><label for=\'jpoker_admin_active_input\'>Active</label></div>',
		respawn: '<div class=\'jpoker_admin_respawn\'><input id=\'jpoker_admin_respawn_input\' name=\'respawn\' type=\'checkbox\' title=\'Control if the tournament restarts when complete.\'><label for=\'jpoker_admin_respawn_input\'>Respawn</label></div>',
