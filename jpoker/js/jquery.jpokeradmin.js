...
(function($) {
    ...
    jpoker.plugins.tourneyAdminEdit.defaults = $.extend({
            ...
            templates: {
                layout: '<form action=\'javascript://\'><div class=\'jpoker_admin_tourney_params\'>{serial}{resthost_serial}{name}{description_short}{description_long}{players_quota}{players_min}{variant}{betting_structure}{seats_per_game}{player_timeout}{currency_serial}{currency_serial_from_date_format}{prize_min}{bailor_serial}{buy_in}{rake}{sit_n_go}{breaks_first}{breaks_interval}{breaks_duration}{start_time}{register_time}{active}{respawn}</div>{update}</form>',
		serial: '<div class=\'jpoker_admin_serial\'><label>Serial<input name=\'serial\' title=\'Serial of the tournament.\' value=\'{serial}\' readonly=\'true\'/></label></div>',
		...
		register_time: '<div class=\'jpoker_admin_register_time\'><label>Register time<input name=\'register_time\' title=\'Time and date of the registration start.\' value=\'{register_time}\' /></label></div>',
		...
		currency_serial_from_date_format: '<div class=\'jpoker_admin_currency_serial_from_date_format\'><label>Currency serial from date format<input name=\'currency_serial_from_date_format\' title=\'Format string to override currency serial from date.\' value=\'{currency_serial_from_date_format}\' /></label></div>',
