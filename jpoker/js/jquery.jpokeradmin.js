...
(function($) {
    ...
    jpoker.plugins.tourneyAdminEdit.defaults = $.extend({
		...
		satellite_of: '<div class=\'jpoker_admin_satellite_of\'><label for=\'jpoker_admin_satellite_of\'>Satellite of</label><input id=\'jpoker_admin_satellite_of\' name=\'satellite_of\' type=\'text\' title=\'Control if the tournament is a satellite, the value is a reference to the serial field of the tourneys_schedule table.\' value=\'{satellite_of}\' /></div>',
		satellite_player_count: '<div class=\'jpoker_admin_satellite_player_count\'><label for=\'jpoker_admin_satellite_player_count\'>Satellite player count</label><input id=\'jpoker_admin_satellite_player_count\' name=\'satellite_player_count\' type=\'text\' title=\'The number of tournament winners that will be registered to the satellite_of tournament\' value=\'{satellite_player_count}\' /></div>',
