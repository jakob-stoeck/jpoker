...
(function($) {
	...
	players : {
	    registering : {
		header : '<table><thead><tr class=\'jpoker_thead_caption\'><th>{caption}</th></tr><tr><th>{name}</th></tr></thead><tbody>',
		rows : '<tr><td>{name}</td></tr>',
		footer : '</tbody></table>'
	    },
	    running : {
		header : '<table><thead><tr class=\'jpoker_thead_caption\'><th colspan=\'3\'>{caption}</th></tr><tr><th>{name}</th><th>{money}</th><th>{rank}</th></tr></thead><tbody>',
		rows : '<tr><td>{name}</td><td>{money}</td><td>{rank}</td></tr>',
		footer : '</tbody></table>'
	    },
	    complete : {
		header : '<table><thead><tr class=\'jpoker_thead_caption\'><th colspan=\'2\'>{caption}</th></tr><tr><th>{name}</th><th>{rank}</th></tr></thead><tbody>',
	...
	tables : {
	    header : '<div class=\'jpoker_tourney_details_tables\'><table><thead><tr class=\'jpoker_thead_caption\'><th colspan=\'5\'>{caption}</th></tr><tr><th>{table}</th><th>{players}</th><th>{max_money}</th><th>{min_money}</th><th>{goto_table}</th></tr></thead><tbody>',
	...
	table_players : {
	    header : '<div class=\'jpoker_tourney_details_table_players\'><table><thead><tr class=\'jpoker_thead_caption\'><th colspan=\'2\'>{caption}</th></tr><tr><th>{player}</th><th>{money}</th></tr></thead><tbody>',
	    rows : '<tr><td>{name}</td><td>{money}</td></tr>',
	    footer : '</tbody></table></div>'
	},
	prizes : {
	    header : '<div class=\'jpoker_tourney_details_prizes\'><table><thead><tr class=\'jpoker_thead_caption\'><th colspan=\'2\'>{caption}</th></tr><tr><th>{rank}</th><th>{prize}</th></tr></thead><tbody>',
	...
	html.push(t.info.supplant($.extend({
		    ...
		    'toggle_password_title': _("Show password"),
		    'email_title': _("Email"),
