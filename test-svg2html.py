...
class SVG2Gtk(unittest.TestCase):
    ...
    def test_SVG2CSS(self):
        ...
        css_string = '.jpoker_table .jpoker_ptable { width:800px; height:800px; position:relative; background-image:url("../images/table_background.png"); }\n.jpoker_table .jpoker_ptable_test { width:2px; height:3px; position:absolute; top:1px; left:0px; background-image:url("../images/test.png");}\n.jpoker_table .jpoker_ptable_test1 { width:2px; height:3px; position:absolute; top:1px; left:0px; }\n'
